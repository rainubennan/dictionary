...
class _MyHomePageState extends State<MyHomePage> {
  ...
  late  List<Map<String, dynamic>> foundwords =[];
  @override
  void initState() {
    super.initState();
    foundwords=_allWords;
  }
      ...
      body: Column(
        children: [
          Padding(
            ...
            child: TextField(style: TextStyle(color: Colors.teal,fontSize: 20),
          ...
          ListView.builder(
              ...
              itemBuilder: (context, index) {
                return Card(
                  ...
                  key: ValueKey(foundwords[index]['id']),
                  ...
                  child: ListTile(
                    leading: Icon(Icons.stacked_line_chart,
                      color: Colors.white,),
                    title: Text(foundwords[index]['name'],
                      style: TextStyle(color: Colors.white,
                      fontSize: 20,fontStyle: FontStyle.italic,letterSpacing: 1),),
                    subtitle: Text(foundwords[index]['mean'],
                    style: TextStyle(color: Colors.white,
                    fontStyle: FontStyle.italic,fontSize:15,letterSpacing: 1 ),),
                    trailing: Text(_allWords[index]['id'].toString(),
                      style: TextStyle(color: Colors.white,
                          fontStyle: FontStyle.italic,fontSize:18,letterSpacing: 1 ,)),)
